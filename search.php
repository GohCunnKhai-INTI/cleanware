...
$id2=$id;
	...
	$id2 = trim(preg_replace('/\s\s+/', ' ', str_replace("\n", " ", $id2)));
	...
	$result=mysqli_query($conn,"select * from product where p_name like '%$id2%'"); 
          ...
          <div id="header"> <!-- header -->
			...
			<div id="content"> <!-- Content -->
              <div class="prd">
                  <div class="container">
                      <div class="prd2">
                          <h3><?php echo $count; ?> results for "<?php echo $id;?>"</h3>
                          <div class="breadcumb"> <a href="product.php">Product</a><span> / </span><span>Search</span></div>
                      ...
                      <div class="newest-content">
                          <div class="newest-tab">
                           <div class="brand-title">
                              <span>Showing All <?php echo $count?> Results</span>
                          </div>     
