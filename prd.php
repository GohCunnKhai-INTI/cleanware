...
$ml="SELECT * FROM product ORDER by pos ASC";
				...
				<div class="brands">
                  <div class="container">
						  ...
						  ?>
							...
							<p style="float:left;"><?php echo nl2br($row7['pr_ldesc']);?> </p>
                  ...
                  <div class="container">
                      <div class="rec-blog-inner">
                          ...
                          <div class="row">
							  ...
							  <?php
							  $count=1;
							  while($row4=mysqli_fetch_assoc($mlt))
							  {
							 ...
							 <div class="col-md-4 blog-ct">
                                  <center><img src=<?php echo 'images/'.$row4['p_img'];?> alt="" id=<?php echo $row4['p_id'];?>
								  class="img-responsive" width="220px" height="250px" onclick="next(this.id)"
								  style="cursor:pointer"></center>
                                  <div class="blog-ct-title">
                                      <h4 id="mlike"><?php echo $row4['p_name'];?></h4>                                    
                                  </div>
                              </div>  
							...
							<script>
								function next(idd){
								window.location.href = "prd.php?id="+idd;
								}
							</script>
